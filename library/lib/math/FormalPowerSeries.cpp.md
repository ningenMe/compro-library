...
* <a href="{{ site.github.repository_url }}/blob/master/lib/math/FormalPowerSeries.cpp">View this file on GitHub</a>
    - Last commit date: 2020-09-06 21:12:06+09:00


* see: <a href="<a href="http://q.c.titech.ac.jp/docs/progs/polynomial_division.html">線形漸化式を満たす数列のN項目を計算するアルゴリズム</a>"><a href="http://q.c.titech.ac.jp/docs/progs/polynomial_division.html">線形漸化式を満たす数列のN項目を計算するアルゴリズム</a></a>
