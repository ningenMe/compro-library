...
# :warning: non-verified/Eratosthenes.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#f62ece6ccc2c02f6163dc5f3da3d641d">non-verified</a>
* <a href="{{ site.github.repository_url }}/blob/master/non-verified/Eratosthenes.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "non-verified/Eratosthenes.cpp"
//Eratosthenes O(N)
vector<int> Eratosthenes(int N) {
    vector<int> res(N + 1, 1);
    res[0] = res[1%(N+1)] = 0;
