...
# :warning: non-verified/FactorialMod.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#f62ece6ccc2c02f6163dc5f3da3d641d">non-verified</a>
* <a href="{{ site.github.repository_url }}/blob/master/non-verified/FactorialMod.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "non-verified/FactorialMod.cpp"
//Factorial Mod
vector<long long> FactorialMod(long long N, long long mod) {
    vector<long long> res(N + 1, 1);
    for (long long i = 1; i <= N; ++i) res[i] = (res[i - 1] * i) % mod;
