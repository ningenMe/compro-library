...
# :warning: non-verified/ZAlgorithm.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#f62ece6ccc2c02f6163dc5f3da3d641d">non-verified</a>
* <a href="{{ site.github.repository_url }}/blob/master/non-verified/ZAlgorithm.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "non-verified/ZAlgorithm.cpp"
// O(N)
vector<int> ZAlgorithm(const string str) {
	int N = str.size();
	vector<int> res(N);
