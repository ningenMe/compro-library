...
# :warning: lib-unverified/ZAlgorithm.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/ZAlgorithm.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/ZAlgorithm.cpp"
// O(N)
vector<int> ZAlgorithm(const string str) {
	int N = str.size();
	vector<int> res(N);
