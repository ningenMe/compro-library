...
# :warning: lib-unverified/NBase.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/NBase.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/NBase.cpp"
vector<long long> NBase(long long X,long long N) {
    assert(abs(N)>1);
    vector<long long> res;
    while(1) {
