...
# :warning: lib-unverified/Eratosthenes.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/Eratosthenes.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/Eratosthenes.cpp"
//Eratosthenes O(N)
vector<int> Eratosthenes(int N) {
    vector<int> res(N + 1, 1);
    res[0] = res[1%(N+1)] = 0;
