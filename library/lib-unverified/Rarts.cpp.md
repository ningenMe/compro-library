...
# :warning: lib-unverified/Rarts.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/Rarts.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/Rarts.cpp"
vector<pair<char,long long>> Rarts(string S){
	char ch = S[0];
	int cnt = 1;
	vector<pair<char,long long>> res;
