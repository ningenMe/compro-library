...
# :warning: lib-unverified/Divisor.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/Divisor.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/Divisor.cpp"
//divisor O(sqrt(N))
set<long long> Divisor(long long N) {
    set<long long> ret;
    for (long long i = 1; i*i <= N; ++i) {
