...
# :warning: lib-unverified/FactorialMod.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#155a5098a95a6467136de23a79cf53bd">lib-unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/lib-unverified/FactorialMod.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "lib-unverified/FactorialMod.cpp"
//Factorial Mod
vector<long long> FactorialMod(long long N, long long mod) {
    vector<long long> res(N + 1, 1);
    for (long long i = 1; i <= N; ++i) res[i] = (res[i - 1] * i) % mod;
