...
# :warning: BinaryIndexedTree2D.cpp

<a href="../index.html">Back to top page</a>

* category: <a href="../index.html#5058f1af8388633f609cadb75a75dc9d">.</a>
* <a href="{{ site.github.repository_url }}/blob/master/BinaryIndexedTree2D.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "BinaryIndexedTree2D.cpp"
template<class T> class BinaryIndexedTree2D {
//抽象化してない　一点加算、区間総和のみ
	const int N,M;
	vector<vector<T>> node;
