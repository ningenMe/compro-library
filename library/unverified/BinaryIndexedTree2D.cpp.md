...
# :warning: unverified/BinaryIndexedTree2D.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#77abbaef317832d0cd0f51a55cb5a0a2">unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/unverified/BinaryIndexedTree2D.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "unverified/BinaryIndexedTree2D.cpp"
template<class T> class BinaryIndexedTree2D {
//抽象化してない　一点加算、区間総和のみ
	const int N,M;
	vector<vector<T>> node;
