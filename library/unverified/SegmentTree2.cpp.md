...
# :warning: unverified/SegmentTree2.cpp

<a href="../../index.html">Back to top page</a>

* category: <a href="../../index.html#77abbaef317832d0cd0f51a55cb5a0a2">unverified</a>
* <a href="{{ site.github.repository_url }}/blob/master/unverified/SegmentTree2.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "unverified/SegmentTree2.cpp"
template<class Operator> class SegmentTree {
	using TypeNode = typename Operator::TypeNode; 
	size_t length;
	size_t num;
