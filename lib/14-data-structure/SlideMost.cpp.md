...
data:
  ...
  attributes:
    ...
    document_title: "SlideMost - \u30B9\u30E9\u30A4\u30C9\u6700\u5C0F\u5024/\u6700\
      \u5927\u5024"
    links: []
  bundledCode: "#line 1 \"lib/14-data-structure/SlideMost.cpp\"\n/*\n * @title SlideMost\
  ...
  verifiedWith:
  - test/data-structure/SlideMost.test.cpp
documentation_of: lib/14-data-structure/SlideMost.cpp
layout: document
redirect_from:
- /library/lib/14-data-structure/SlideMost.cpp
- /library/lib/14-data-structure/SlideMost.cpp.html
