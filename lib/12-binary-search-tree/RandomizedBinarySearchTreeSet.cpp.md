...
data:
  ...
  attributes:
    ...
    document_title: "RandomizedBinarySearchTree - \u30E9\u30F3\u30C0\u30E0\u5E73\u8861\
      \u4E8C\u5206\u63A2\u7D22\u6728set"
    links: []
  bundledCode: "#line 1 \"lib/12-binary-search-tree/RandomizedBinarySearchTreeSet.cpp\"\
  ...
  code: "/*\n * @title RandomizedBinarySearchTree - \u30E9\u30F3\u30C0\u30E0\u5E73\
    \u8861\u4E8C\u5206\u63A2\u7D22\u6728set\n * @docs md/binary-search-tree/RandomizedBinarySearchTree.md\n\
    \ */\ntemplate<class Monoid> class RandomizedBinarySearchTreeSet {\n    using\
    \ TypeNode = typename Monoid::TypeNode;\n    unsigned int x = 123456789, y = 362436069,\
    \ z = 521288629, w = 88675123;\n    unsigned int xor_shift() {\n        unsigned\
...
layout: document
redirect_from:
- /library/lib/12-binary-search-tree/RandomizedBinarySearchTreeSet.cpp
- /library/lib/12-binary-search-tree/RandomizedBinarySearchTreeSet.cpp.html
title: "RandomizedBinarySearchTree - \u30E9\u30F3\u30C0\u30E0\u5E73\u8861\u4E8C\u5206\
  \u63A2\u7D22\u6728set"
---
