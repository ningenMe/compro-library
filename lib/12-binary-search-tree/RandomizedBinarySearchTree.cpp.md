...
data:
  ...
  attributes:
    ...
    document_title: "RandomizedBinarySearchTree - \u5E73\u8861\u4E8C\u5206\u63A2\u7D22\
      \u6728"
    links: []
  bundledCode: "#line 1 \"lib/12-binary-search-tree/RandomizedBinarySearchTree.cpp\"\
...
layout: document
redirect_from:
- /library/lib/12-binary-search-tree/RandomizedBinarySearchTree.cpp
- /library/lib/12-binary-search-tree/RandomizedBinarySearchTree.cpp.html
