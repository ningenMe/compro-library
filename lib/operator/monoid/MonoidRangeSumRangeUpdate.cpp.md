...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"lib/operator/monoid/MonoidRangeSumRangeUpdate.cpp\"\n//node:\u7DCF\
    ...
    \ new_lazy;}\n\tinline static constexpr TypeNode fucn_operate(TypeNode node,TypeLazy\
...
documentation_of: lib/operator/monoid/MonoidRangeSumRangeUpdate.cpp
layout: document
redirect_from:
- /library/lib/operator/monoid/MonoidRangeSumRangeUpdate.cpp
- /library/lib/operator/monoid/MonoidRangeSumRangeUpdate.cpp.html
