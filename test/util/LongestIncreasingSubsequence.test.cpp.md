...
data:
  ...
  bundledCode: "#line 1 \"test/util/LongestIncreasingSubsequence.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_D\"\
    \n\n#include <vector>\n#include <iostream>\nusing namespace std;\n#line 1 \"lib/util/LongestIncreasingSubsequence.cpp\"\
  ...
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DPL_1_D\"\
    \n\n#include <vector>\n#include <iostream>\nusing namespace std;\n#include \"\
    ../../lib/util/LongestIncreasingSubsequence.cpp\"\n\nint main(void){\n    cin.tie(0);ios::sync_with_stdio(false);\n\
    \    int N; cin >> N;\n    vector<long long> a(N);\n    for(int i=0;i<N;++i) cin\
    \ >> a[i];\n    cout << LongestIncreasingSubsequence(a) << endl;\n\treturn 0;\n\
    }"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: test/util/LongestIncreasingSubsequence.test.cpp
layout: document
redirect_from:
- /verify/test/util/LongestIncreasingSubsequence.test.cpp
- /verify/test/util/LongestIncreasingSubsequence.test.cpp.html
