...
data:
  ...
  bundledCode: "#line 1 \"test/convex-hull-trick/ConvexHullTrick-max.test.cpp\"\n\
    ...
    \       ( Operator::func_compare(y(lines.get(md),x),y(lines.get(md+1),x)) ?ok:ng)=md;\n\
    \        }\n        return lines.get(ok);\n    }\n\n    void print() {\n     \
    \   lines.print();\n    }\n};\n#line 10 \"test/convex-hull-trick/ConvexHullTrick-max.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/convex-hull-trick/ConvexHullTrick-max.test.cpp
layout: document
redirect_from:
- /verify/test/convex-hull-trick/ConvexHullTrick-max.test.cpp
- /verify/test/convex-hull-trick/ConvexHullTrick-max.test.cpp.html
