...
data:
  ...
  bundledCode: "#line 1 \"test/polynomial/FormalPowerSeries-inv.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/inv_of_formal_power_series\"\n\n#include\
    \ <vector>\n#include <iostream>\n#include <numeric>\n#include <algorithm>\n#include\
    ...
    , \" << fps[i];return os << \"}\";}\n};\n#line 14 \"test/polynomial/FormalPowerSeries-inv.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/polynomial/FormalPowerSeries-inv.test.cpp
- /verify/test/polynomial/FormalPowerSeries-inv.test.cpp.html
