...
data:
  ...
  bundledCode: "#line 1 \"test/polynomial/FormalPowerSeries-multi-eval.test.cpp\"\n\
    ...
    , \" << fps[i];return os << \"}\";}\n};\n#line 14 \"test/polynomial/FormalPowerSeries-multi-eval.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/polynomial/FormalPowerSeries-multi-eval.test.cpp
layout: document
redirect_from:
- /verify/test/polynomial/FormalPowerSeries-multi-eval.test.cpp
- /verify/test/polynomial/FormalPowerSeries-multi-eval.test.cpp.html
