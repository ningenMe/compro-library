...
data:
  ...
  bundledCode: "#line 1 \"test/segment/SegmentTreeBeats-1.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/range_chmin_chmax_add_range_sum\"\n\n#include\
    \ <vector>\n#include <iostream>\n#include <stack>\nusing namespace std;\n#line\
    \ 1 \"lib/segment/SegmentTreeBeats.cpp\"\n/*\n * @title SegmentTreeBeats\n */\n\
    ...
    if(b <= range[k].first || range[k].second <= a) continue;\n\t\t\tif(a <= range[k].first\
    \ && range[k].second <= b) {\n\t\t\t\tv += node_sum[k];\n\t\t\t\tcontinue;\n\t\
    \t\t}\n\t\t\tdown_propagate(k);\n\t\t}\n\t\treturn v;\n\t}\n};\n#line 8 \"test/segment/SegmentTreeBeats-1.test.cpp\"\
  ...
  requiredBy: []
  timestamp: '2020-06-16 22:38:57+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/segment/SegmentTreeBeats-1.test.cpp
layout: document
redirect_from:
- /verify/test/segment/SegmentTreeBeats-1.test.cpp
- /verify/test/segment/SegmentTreeBeats-1.test.cpp.html
