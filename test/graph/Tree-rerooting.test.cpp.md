...
data:
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/900\"\n\n#include <vector>\n\
    ...
    \ constexpr TypeNode func_merge(TypeNode node,TypeLazy lazy,int l,int r){return\
    \ {node.first+node.second*lazy,node.second};}\n\tinline static constexpr bool\
