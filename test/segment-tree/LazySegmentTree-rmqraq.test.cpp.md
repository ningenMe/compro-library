...
data:
  ...
  bundledCode: "#line 1 \"test/segment-tree/LazySegmentTree-rmqraq.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=DSL_2_H\"\
    ...
    \   cout << \" }\" << endl;\n    }\n};\n#line 1 \"lib/99-operator/monoid-lazy/MonoidRangeFoldMinRangeOperateAdd.cpp\"\
    \n/*\n * @title MonoidRangeFoldMinRangeOperateAdd - fold:\u533A\u9593min, operate:\u533A\
    ...
    \ node,TypeLazy lazy,int l, int r){return node+lazy;}\n};\n#line 8 \"test/segment-tree/LazySegmentTree-rmqraq.test.cpp\"\
  ...
  dependsOn:
  - lib/10-segment-tree/LazySegmentTree.cpp
  - lib/99-operator/monoid-lazy/MonoidRangeFoldMinRangeOperateAdd.cpp
