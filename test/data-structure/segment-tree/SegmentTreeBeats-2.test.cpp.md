...
data:
  ...
  bundledCode: "#line 1 \"test/data-structure/segment-tree/SegmentTreeBeats-2.test.cpp\"\
    ...
    \       if(a <= range[k].first && range[k].second <= b) {\n                v +=\
    \ node_sum[k];\n                continue;\n            }\n            down_propagate(k);\n\
    \        }\n        return v;\n    }\n};\n#line 8 \"test/data-structure/segment-tree/SegmentTreeBeats-2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/data-structure/segment-tree/SegmentTreeBeats-2.test.cpp
layout: document
redirect_from:
- /verify/test/data-structure/segment-tree/SegmentTreeBeats-2.test.cpp
- /verify/test/data-structure/segment-tree/SegmentTreeBeats-2.test.cpp.html
