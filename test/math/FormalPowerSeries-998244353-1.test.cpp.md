...
data:
  ...
  bundledCode: "#line 1 \"test/math/FormalPowerSeries-998244353-1.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/convolution_mod\"\n\n#include <vector>\n\
    #include <iostream>\n#include <numeric>\n#include <algorithm>\n#include <array>\n\
  ...
  verifiedWith: []
documentation_of: test/math/FormalPowerSeries-998244353-1.test.cpp
layout: document
redirect_from:
- /verify/test/math/FormalPowerSeries-998244353-1.test.cpp
- /verify/test/math/FormalPowerSeries-998244353-1.test.cpp.html
