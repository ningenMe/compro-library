...
data:
  ...
  bundledCode: "#line 1 \"test/math/NumberTheoreticTransform2.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/1068\"\n\n#include <vector>\n#include\
    \ <iostream>\n#include <numeric>\n#include <algorithm>\n#include <array>\n\nusing\
    ...
    \ h){return convolution_arbitrarymod(g,h);}\n};\n#line 12 \"test/math/NumberTheoreticTransform2.test.cpp\"\
    \nconstexpr long long MOD = 998244353;\n\nvector<vector<ModInt<MOD>>> v;\nvector<ModInt<MOD>>\
    \ rec(int l, int r,NumberTheoreticTransform<MOD>& ntt) {\n    if(r-l==1) return\
  ...
  verifiedWith: []
documentation_of: test/math/NumberTheoreticTransform2.test.cpp
layout: document
redirect_from:
- /verify/test/math/NumberTheoreticTransform2.test.cpp
- /verify/test/math/NumberTheoreticTransform2.test.cpp.html
