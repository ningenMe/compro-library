...
data:
  ...
  bundledCode: "#line 1 \"test/math/NumberTheoreticalTransform-conv-1000000007-1.test.cpp\"\
    ...
    };\n#line 12 \"test/math/NumberTheoreticalTransform-conv-1000000007-1.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/convolution_mod_1000000007\"\
    ...
    \    int N,M; cin >> N >> M;\n    vector<modint> A(N),B(M);\n    for(int i = 0;\
    \ i < N; ++i) cin >> A[i];\n    for(int i = 0; i < M; ++i) cin >> B[i];\n\tauto\
    \ C = NumberTheoreticalTransform<modint>::convolution(A,B);\n    for(int i = 0;\
    \ i < N+M-1; ++i) cout << C[i] << \" \";\n    cout << endl;\n\treturn 0;\n}"
  dependsOn:
  - lib/util/ModInt.cpp
  ...
  requiredBy: []
  timestamp: '2021-04-08 01:45:59+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/math/NumberTheoreticalTransform-conv-1000000007-1.test.cpp
layout: document
redirect_from:
- /verify/test/math/NumberTheoreticalTransform-conv-1000000007-1.test.cpp
- /verify/test/math/NumberTheoreticalTransform-conv-1000000007-1.test.cpp.html
